...
window.bseRenderDebtRelief = function() {
  ...
  /* Layer 1: calm orientation */
  h += '<div class="bse-dl"><div class="bse-dl-orient">' + orient + '</div>';
  if (fcf > 0) h += '<div class="bse-dl-capacity">You have <strong>' + fmtMoney(fcf) + '/mo</strong> in free cash flow. That is your tool here.</div>';
  h += '</div>';
  /* Layer 2: single priority */
